...
def main():
    ...
    for i in range(5):
        try:
            ...
            torch.jit.save(last_model, os.path.join(MODEL_PATH, f"LaneLineCoordinates-LAST-{TRAINING_DATE}.pt"), _extra_files=metadata)
    ...
    for i in range(5):
        try:
            ...
            torch.jit.save(best_model, os.path.join(MODEL_PATH, f"LaneLineCoordinates-BEST-{TRAINING_DATE}.pt"), _extra_files=metadata)
